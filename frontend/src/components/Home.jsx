  ...
  const testimonials = [
    {
      ...
      content:
        "The real-time video simulation and instant feedback helped me ace my technical interviews. Best platform hands down!",
      rating: 5,
    },
    {
      ...
      content:
        "Started practicing within minutes. The AI-powered insights were incredibly helpful in improving my responses.",
      rating: 4.5,
    },
    {
      name: "Priya Patel",
      ...
      content:
        "The deep analysis of each answer helped me understand my strengths and areas for improvement. Game-changer!",
      rating: 4.7,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-24 mb-16 text-center">
          ...
          <p className="text-xl text-teal-700 mb-8 max-w-2xl mx-auto">
            Experience the most realistic interview simulation with live video,
            audio, and AI-powered deep insights. Join 50,000+ successful
            candidates who landed their dream jobs.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-yellow-200 hover:border-yellow-300 transition-all">
              ...
              <p className="text-teal-700">
                Ultra-realistic interview experience with live video and audio
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-yellow-200 hover:border-yellow-300 transition-all">
              ...
              <p className="text-teal-700">
                Get comprehensive insights on your answers, body language, and
                speaking patterns.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-yellow-200 hover:border-yellow-300 transition-all">
              ...
              <p className="text-teal-700">
                Receive immediate, actionable feedback to improve your interview
                performance.
              </p>
            </div>
          </div>
        ...
        <div className="mb-24">
          ...
          <div className="space-y-32">
            ...
            <div className="flex flex-col items-center group">
              <div className="inline-block bg-yellow-100 text-yellow-700 px-4 py-1 rounded-full font-semibold mb-4">
                Step 1
              </div>
              <h3 className="text-3xl font-semibold text-teal-900 mb-8">
                Upload Your Resume
              </h3>
              <img
                src={uploadImage}
              ...
              <p className="text-xl text-teal-700 leading-relaxed max-w-3xl text-center">
                Simply upload your resume and our AI will instantly analyze your
                background to create personalized interview questions tailored
                to your experience.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center group">
              ...
              />
              <p className="text-xl text-teal-700 leading-relaxed max-w-3xl text-center">
                Select from over 50+ job roles across different industries. Get
                domain-specific questions that actually get asked in real
                interviews.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center group">
              ...
              />
              <p className="text-xl text-teal-700 leading-relaxed max-w-3xl text-center">
                Begin your interview immediately with our AI interviewer. Get
                real-time feedback and detailed analysis of each response to
                improve instantly.
              </p>
            </div>
          </div>
