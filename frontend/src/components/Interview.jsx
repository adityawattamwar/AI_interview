...
export const Interview = ({ questions, onComplete }) => {
  ...
  const handleStopInterview = async () => {
    ...
    try {
      ...
      setError(
        error.message || "Failed to complete the interview. Please try again."
      );
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-yellow-50">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl">
              ...
              <p className="text-gray-600 mb-6">
                Are you sure you want to stop the interview? This action cannot
                be undone and your progress will be submitted as is.
              </p>
      ...
      {error && (
        <div
          className="fixed bottom-4 left-1/2 transform -translate-x-1/2 px-6 py-3 
