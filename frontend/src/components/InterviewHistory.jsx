...
export const InterviewHistory = ({ feedbackHistory }) => {
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Track your progress and growth across interviews
        </p>
      </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-6">
                ...
                <span
                  className={`px-3 py-1 text-sm font-medium rounded-full ${getScoreBadgeStyle(
                ...
                <div className="mt-6">
                  ...
                  <div className="space-y-4">
                    {interview.questions.map((q, qIndex) => (
                      <div key={qIndex} className="bg-gray-50 rounded-lg p-5">
